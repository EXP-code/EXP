...
void MSSAtoolkitClasses(py::module &m) {
  ...
  m.doc() =
    ...
    "     diagnostics (e.g. visualizing fields).  The 'reconstruct()'\n"
    "     call updates the internal working channel data. At the end of\n"
    "     the 'getReconstructed()' call, these updates are copied back to\n"
    "     the Coefs object passed to expMSSA when it was contructed. In\n"
    "     practice, the coefficients object that you made in Python will\n"
    "     always contain the latest updates.  This allows you to update\n"
    ...
    "below are simple boolean toggles.  That is there presence turns on\n"
    "the feature independent of the value.  The Python script samples\n"
    "show how to construct these simple YAML configurations on the fly.\n"
    "A simple example is also given below.  The boolean parameters are\n"
    "listed below by my guess of their usefulness to most people:\n\n"
