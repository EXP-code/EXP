...
PYBIND11_MODULE(pyEXP, m)
{
  m.doc() =
    ...
    "How to get started\n"
    "------------------\n"
    "The main documentation are the docstrings embedded in the code\n"
    "and a set of examples provided with the EXP source.  We hope to\n"
    "provide a online reference guide in the future.\n\n"
    "We recommend beginning with the example Python scripts and\n"
    "notebooks and adapting them to your needs.  You can explore\n"
    "all of the available classes and member functions using the\n"
    "usual ``help'' function.  The classes are organized into sub-\n"
    ...
    "quick start (check the pyEXP directory).  Run 'help(pyEXP.xxxx) for\n"
    "each of the submodules below for more detailed usage info...\n\n"
