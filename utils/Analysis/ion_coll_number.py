...
def plot_data(filename, msz, line, dot, elastic, useTime, fullScreen, stride, trange):
...
def main(argv):
    ...
    plot_data(filename, args.size, args.line, args.point, args.elastic, args.time, args.full, args.stride, [args.Tmin, args.Tmax])
