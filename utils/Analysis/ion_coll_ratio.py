...
def plot_data(filename, msz, dot, summary):
...
def main(argv):
    ...
    try:
        opts, args = getopt.getopt(argv,"hm:ps", ["help", "msize=", "point", "summary"])
    except getopt.GetoptError:
        print 'Syntax Error'
        print sys.argv[0], '[-p | --point | -m <size> | --msize=<size> | -s | --summary] <runtag>'
        sys.exit(2)
    for opt, arg in opts:
        if opt in ("-h", "--help"):
            print sys.argv[0], '[-p | --point | -m <size> | --msize=<size>] <runtag>'
            sys.exit()
        elif opt in ("-p", "--point"):
            dot = True
        elif opt in ("-m", "--msize"):
    ...
    plot_data(filename, msz, dot, rpt)
