...
def plot_data(filename, degree, smooth, msize, tscale=1.0e5, logY=False, dot=False):
...
def main(argv):
    ...
    try:
        opts, args = getopt.getopt(argv,"hd:s:m:t:lp", ["deg=", "smooth=", "msize=", "timescale=", "log", "point"])
    except getopt.GetoptError:
        print sys.argv[0], '[-d <degree> | --deg=<degree> | -s <smooth> | --smooth=<smooth> | -m <size> | --msize=<size> | -l | --log | -p | --point] <runtag>'
        sys.exit(2)
    for opt, arg in opts:
        if opt == '-h':
            print sys.argv[0], '[-d <degree> | --deg=<degree> | -s <smooth> | --smooth=<smooth> | -m <size> | --msize=<size> | -l | --log | -p | --point] <runtag>'
    ...
    plot_data(filename, degree, smooth, msize, tscale, logY, dot)
