...
def plot_data(nametag, window, order, msz, dot, scr):
...
def main(argv):
    ...
    try:
        opts, args = getopt.getopt(argv,"hw:o:m:ps", ["window=", "order=", "msize=", "point", "screen"])
    ...
    plot_data(nametag, window, order, msz, dot, scr)
