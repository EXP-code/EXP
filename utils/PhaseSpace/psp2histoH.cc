...
main(int ac, char **av)
{
  ...
  // Parse command line
  //
  cxxopts::Options options(prog, "Separate a psp structure and make a 1-d histogram.  Hybrid species version.\n");
  ...
  options.add_options()
   ...
   ("t,time", "find closest time slice to requested value",
   ...
   ("H,hybrid", "position of species fraction index",
     cxxopts::value<int>(hindx)->default_value("7"))
