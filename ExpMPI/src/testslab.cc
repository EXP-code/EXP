...
main(int argc, char** argv)
{
  ...
  name = OUTFILE + ".potl";
  out[0] = new ofstream (name.c_str());
  name = OUTFILE + ".dens";
  out[1] = new ofstream (name.c_str());
  name = OUTFILE + ".force";
  out[2] = new ofstream (name.c_str());

  name = OUTFILE + ".potl.proj";
  out[3] = new ofstream (name.c_str());
  name = OUTFILE + ".dens.proj";
  out[4] = new ofstream (name.c_str());
  name = OUTFILE + ".force.proj";
  out[5] = new ofstream (name.c_str());
