...
void global_setup_halo(void)
{
  ...
  if (myid==0) {
    cout << "Using external halo model\n";
    write_parm();
  }
}
...
static void write_parm(void)
{
  cout << setw(30) << "HMODEL="    << HMODEL     << endl;
  cout << setw(30) << "INFILE="    << INFILE     << endl;
  cout << setw(30) << "MHALO="     << MHALO      << endl;
  cout << setw(30) << "RHALO="     << RHALO      << endl;
  cout << setw(30) << "RMODMIN="   << RMODMIN    << endl;
  cout << setw(30) << "RMOD="      << RMOD       << endl;
  cout << setw(30) << "RBCORE="    << RBCORE     << endl;
  cout << setw(30) << "MBULGE="    << MBULGE     << endl;
  cout << setw(30) << "RBULGE="    << RBULGE     << endl;
  cout << setw(30) << "RBMODMIN="  << RBMODMIN   << endl;
  cout << setw(30) << "RBMOD="     << RBMOD      << endl;
}
