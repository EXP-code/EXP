...
#ifdef DEBUG    
	    cout.form("Master sending orders to Slave %d: l=%d\n", 
		      slave, l);
#endif
	    MPI_Send(&request_id, 1, MPI_INT, slave, 11, MPI_COMM_WORLD);
...
#ifdef DEBUG    
	    cout.form("Master gave orders to Slave %d: l=%d\n", 
		      slave, l);
#endif
...
#ifdef DEBUG
    cout.form("Slave %d: ordered to compute l = %d\n", mpi_myid, L);
#endif
...
#ifdef DEBUG
    cout.form("Slave %d: computed l = %d\n", mpi_myid, L);
...
#ifdef DEBUG
    cout.form("Slave %d: sent to master l = %d\n", mpi_myid, L);
#endif
...
#ifdef DEBUG    
  cout.form("Process %d unpacking table entry from Process %d: l=%d\n", 
	    mpi_myid, retid, l);
#endif
...
#ifdef DEBUG    
	    cout.form("Master sending orders to Slave %d: Kx=%d, Ky=%d\n", 
		      slave, kx, ky);
#endif
	    MPI_Send(&request_id, 1, MPI_INT, slave, 11, MPI_COMM_WORLD);
...
#ifdef DEBUG    
	    cout.form("Master gave orders to Slave %d: Kx=%d, Ky=%d\n", 
		      slave, kx,ky);
#endif
...
#ifdef DEBUG
    cout.form("Slave %d: ordered to compute Kx, Ky = %d, %d\n", mpi_myid, 
	      KX, KY);
#endif
...
#ifdef DEBUG
    cout.form("Slave %d: Kx, Ky = %d, %d [Even inputs]\n", mpi_myid, KX, KY);
    for (int n=0; n<8; n++)
...
#ifdef DEBUG
    cout.form("Slave %d: computed Kx, Ky = %d, %d [Even]\n", mpi_myid, KX, KY);
...
#ifdef DEBUG
    cout.form("Slave %d: computed Kx, Ky = %d, %d [Odd]\n", mpi_myid, KX, KY);
...
#ifdef DEBUG
    cout.form("Slave %d: sent to master Kx, Ky = %d, %d\n", mpi_myid, KX, KY);
#endif
...
#ifdef DEBUG    
  cout.form("Process %d unpacking table entry from Process %d: kx=%d, ky=%d\n", 
	    mpi_myid, retid, kx, ky);
#endif
