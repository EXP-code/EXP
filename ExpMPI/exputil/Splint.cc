...
void Splint2(const Vector &xa, const Vector &ya, const Vector &y2a, double x, double &y, double &dy)
{
  int klo, khi, n1, n2, k;
  double h,b,a;
  void nrerror(char *);
...
void Splint3(const Vector &xa, const Vector &ya, const Vector &y2a, double x, double &y, double &dy, double &ddy)
{
  int klo, khi, n1, n2, k;
  double h,b,a;
  void nrerror(char *);
