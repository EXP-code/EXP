...
extern void Jacobi(int n, double alpha, double beta, double abscis[], double weight[]);
extern void Radau_Jacobi(int, double alpha, double beta, double abscis[], double weight[], double* leftw);
extern void Lobatto_Jacobi(int n, double alpha, double beta, double abscis[], double weight[], double* leftw, double* rightw);
